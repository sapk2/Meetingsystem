...
Route::group(['middleware' => ['auth', 'user']], function () {
    ...
    Route::get('user/agenda', [usersController::class, 'agenda'])->name('user.agenda');
    Route::get('user/notice', [usersController::class, 'notice'])->name('notice');

    Route::get('user/profile', [usersController::class, 'show'])->name('user.profile.show');
    Route::get('profile/edit', [usersController::class, 'edituserprofile'])->name('user.profile.edit');
    Route::post('/profile/update', [usersController::class, 'update'])->name('user.profile.update');
    Route::post('/profile/password', [usersController::class, 'changepassword'])->name('user.profile.changepassword');
    Route::post('/profile/uploadphoto', [usersController::class, 'uploadphoto'])->name('user.profile.uploadphoto');
    Route::post('/profile/delete', [usersController::class, 'delete'])->name('user.profile.delete');
});
