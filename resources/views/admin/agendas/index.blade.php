...
<div class="p-4 sm:ml-64">
   <div class="p-4 border-2 border-gray-200 mt-14">
      <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
        ...
        <a href="{{route('admin.agendas.create')}}" class="bg-amber-600 text-white p-3 rounded-lg">Add Category</a>
    </div>
            <div>
         ...
         <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
            ...
            <tbody>
               ...
               <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                  ...
                  <td class="border p-3">
                     <a href="{{ route('agendas.edit', $agenda->id) }}" class="bg-blue-500 text-white p-2 rounded-lg">Edit</a>
                     <a href="{{ route('agendas.destroy', $agenda->id) }}" class="bg-red-500 text-white p-2 rounded-lg" onclick="event.preventDefault(); document.getElementById('delete-form-{{ $agenda->id }}').submit();">Delete</a>
